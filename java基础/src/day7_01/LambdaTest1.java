...
/*
   ...
   5.如果一个接口中，只包含一个抽象方法的接口，称为函数式接口，我们可以在任意函数式接口上使用 @FunctionalInterface 注解，这样做可以检查它是否是一个函数式接口
...
public class LambdaTest1 {
    ...
    public void test5(){
        ...
        System.out.println(com1.compare(13, 56));
        System.out.println("************************");
    ...
    public void test6(){
        ...
        System.out.println(com1.compare(456, 21));
